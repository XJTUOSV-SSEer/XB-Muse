...
public:
    ...
    unordered_map<int,unordered_map<string,BloomFilter<32, GGM_SIZE, HASH_SIZE>>> Revtag;
...
public:
    ...
    void delFile(int userId,unordered_map<string,BloomFilter<32, GGM_SIZE, HASH_SIZE>> Revoketags,vector<string> DelCntDiffs);
